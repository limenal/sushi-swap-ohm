...
export class Factory extends Entity {
  constructor(id: string) {
    ...
    this.set("liquidityETH", Value.fromBigDecimal(BigDecimal.zero()));
...
export class Token extends Entity {
  constructor(id: string) {
    ...
    this.set("whitelistPairs", Value.fromStringArray(new Array(0)));
  }
...
export class CustomPair extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
    ...
    this.set("trackedReserveETH", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("token0Price", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("token0PriceOpen", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("token0PriceHigh", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("token0PriceLow", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("token1Price", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("token1PriceOpen", Value.fromBigDecimal(BigDecimal.zero()));
    this.set("token1PriceHigh", Value.fromBigDecimal(BigDecimal.zero()));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save CustomPair entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save CustomPair entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("CustomPair", id.toString(), this);
    }
  }

  static load(id: string): CustomPair | null {
    return changetype<CustomPair | null>(store.get("CustomPair", id));
  }
  ...
  get token0PriceOpen(): BigDecimal {
    let value = this.get("token0PriceOpen");
    return value!.toBigDecimal();
  }

  set token0PriceOpen(value: BigDecimal) {
    this.set("token0PriceOpen", Value.fromBigDecimal(value));
  }
  ...
  get token1PriceOpen(): BigDecimal {
    let value = this.get("token1PriceOpen");
    return value!.toBigDecimal();
  }

  set token1PriceOpen(value: BigDecimal) {
    this.set("token1PriceOpen", Value.fromBigDecimal(value));
  }
...
export class PairMinute extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
    ...
    this.set("txCount", Value.fromBigInt(BigInt.zero()));
    this.set("timestamp", Value.fromBigInt(BigInt.zero()));
    this.set("secondPair", Value.fromStringArray(new Array(0)));
  }

  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PairMinute entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save PairMinute entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("PairMinute", id.toString(), this);
    }
  }

  static load(id: string): PairMinute | null {
    return changetype<PairMinute | null>(store.get("PairMinute", id));
  }
  ...
  get secondPair(): Array<string> {
    let value = this.get("secondPair");
    return value!.toStringArray();
  }

  set secondPair(value: Array<string>) {
    this.set("secondPair", Value.fromStringArray(value));
  }
}

export class PairHour extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
    ...
    this.set("txCount", Value.fromBigInt(BigInt.zero()));
    this.set("timestamp", Value.fromBigInt(BigInt.zero()));
    this.set("minutePair", Value.fromStringArray(new Array(0)));
  }

  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PairHour entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save PairHour entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("PairHour", id.toString(), this);
    }
  }

  static load(id: string): PairHour | null {
    return changetype<PairHour | null>(store.get("PairHour", id));
  }
  ...
  get minutePair(): Array<string> {
    let value = this.get("minutePair");
    return value!.toStringArray();
  }

  set minutePair(value: Array<string>) {
    this.set("minutePair", Value.fromStringArray(value));
  }
}

export class PairDay extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
    ...
    this.set("txCount", Value.fromBigInt(BigInt.zero()));
    this.set("timestamp", Value.fromBigInt(BigInt.zero()));
    this.set("hourPair", Value.fromStringArray(new Array(0)));
  }

  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PairDay entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save PairDay entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("PairDay", id.toString(), this);
    }
  }

  static load(id: string): PairDay | null {
    return changetype<PairDay | null>(store.get("PairDay", id));
  }
  ...
  get hourPair(): Array<string> {
    let value = this.get("hourPair");
    return value!.toStringArray();
  }

  set hourPair(value: Array<string>) {
    this.set("hourPair", Value.fromStringArray(value));
  }
}

export class PairYear extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
    ...
    this.set("txCount", Value.fromBigInt(BigInt.zero()));
    this.set("timestamp", Value.fromBigInt(BigInt.zero()));
    this.set("dayPair", Value.fromStringArray(new Array(0)));
  }

  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PairYear entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save PairYear entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("PairYear", id.toString(), this);
    }
  }

  static load(id: string): PairYear | null {
    return changetype<PairYear | null>(store.get("PairYear", id));
  }
  ...
  get dayPair(): Array<string> {
    let value = this.get("dayPair");
    return value!.toStringArray();
  }

  set dayPair(value: Array<string>) {
    this.set("dayPair", Value.fromStringArray(value));
  }
}
