...
import { BIG_DECIMAL_ZERO, BIG_INT_ZERO, NULL_CALL_RESULT_VALUE } from '../utils/Constants'
...
//   const contract = ERC20.bind(address)
//   let totalSupplyValue: i32 = 0
//   const totalSupplyResult: i32 = contract.try_totalSupply()
